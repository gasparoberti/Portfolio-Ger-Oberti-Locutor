...
namespace PortfolioCore.Controllers
{
    public class TipsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,titulo,descripcion,contenido,archivoImagen,visible,prioridad,fecha_alta,video,contenido2,visibleV,visibleC2")] Tip tip)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,titulo,descripcion,contenido,imagen,visible,prioridad,fecha_alta,archivoImagen,video,contenido2,visibleV,visibleC2")] Tip tip)
        {
            if (id != tip.id)
            {
                return NotFound();
